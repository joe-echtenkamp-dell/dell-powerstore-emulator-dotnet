...
{ 
    /// <summary>
    /// Performance metrics for the ip port (total) collected at twenty second interval. Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByIpPort : IEquatable<BasePerformanceMetricsByIpPort>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByIpPort {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByIpPort)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByIpPort instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByIpPort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByIpPort other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByIpPort left, BasePerformanceMetricsByIpPort right)
        {

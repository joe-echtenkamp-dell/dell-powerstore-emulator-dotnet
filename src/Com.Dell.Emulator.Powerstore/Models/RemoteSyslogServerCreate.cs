...
{ 
    /// <summary>
    /// Create a remote syslog server configuration. Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class RemoteSyslogServerCreate : IEquatable<RemoteSyslogServerCreate>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoteSyslogServerCreate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RemoteSyslogServerCreate)obj);
        }

        /// <summary>
        /// Returns true if RemoteSyslogServerCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of RemoteSyslogServerCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSyslogServerCreate other)
        {
        ...
        public static bool operator ==(RemoteSyslogServerCreate left, RemoteSyslogServerCreate right)
        {

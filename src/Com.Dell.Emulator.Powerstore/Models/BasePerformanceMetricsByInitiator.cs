...
{ 
    /// <summary>
    /// Performance metrics for the initiator collected at twenty second interval. Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByInitiator : IEquatable<BasePerformanceMetricsByInitiator>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByInitiator {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByInitiator)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByInitiator instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByInitiator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByInitiator other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByInitiator left, BasePerformanceMetricsByInitiator right)
        {

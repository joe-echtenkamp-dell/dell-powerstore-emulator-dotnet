...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsByVolume : MetricsGenerateResponse, IEquatable<PerformanceMetricsByVolume>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsByVolume {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsByVolume)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsByVolume instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsByVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsByVolume other)
        {
        ...
        public static bool operator ==(PerformanceMetricsByVolume left, PerformanceMetricsByVolume right)
        {

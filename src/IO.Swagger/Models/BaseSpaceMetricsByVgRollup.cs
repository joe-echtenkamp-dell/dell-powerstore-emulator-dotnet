...
{ 
    /// <summary>
    /// Summary of volume group level space metric data for one hour or one day period beginning with timestamp, including the maximum and final values for that period.
    /// </summary>
    [DataContract]
    public partial class BaseSpaceMetricsByVgRollup : IEquatable<BaseSpaceMetricsByVgRollup>
    { 
        /// <summary>
        /// Unique identifier representing a specific volume group.
        /// </summary>
        /// <value>Unique identifier representing a specific volume group.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseSpaceMetricsByVgRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseSpaceMetricsByVgRollup)obj);
        }

        /// <summary>
        /// Returns true if BaseSpaceMetricsByVgRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseSpaceMetricsByVgRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseSpaceMetricsByVgRollup other)
        {
        ...
        public static bool operator ==(BaseSpaceMetricsByVgRollup left, BaseSpaceMetricsByVgRollup right)
        {

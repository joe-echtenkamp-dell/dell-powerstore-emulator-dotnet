...
{ 
    /// <summary>
    /// Copy metrics for the appliance. Was added in version 3.5.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseCopyMetricsByApplianceRollup : IEquatable<BaseCopyMetricsByApplianceRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseCopyMetricsByApplianceRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseCopyMetricsByApplianceRollup)obj);
        }

        /// <summary>
        /// Returns true if BaseCopyMetricsByApplianceRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseCopyMetricsByApplianceRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCopyMetricsByApplianceRollup other)
        {
        ...
        public static bool operator ==(BaseCopyMetricsByApplianceRollup left, BaseCopyMetricsByApplianceRollup right)
        {

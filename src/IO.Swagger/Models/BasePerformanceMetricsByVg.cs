...
{ 
    /// <summary>
    /// Performance metrics for the volumes in a volume group collected at twenty second interval.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByVg : IEquatable<BasePerformanceMetricsByVg>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Read rate in byte/sec.</value>
        ...
        /// <summary>
        /// Average additional latency incurred on the source in order to do the remote mirror writes in microseconds. This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Average additional latency incurred on the source in order to do the remote mirror writes in microseconds. This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.</value>

        [DataMember(Name="avg_mirror_overhead_latency")]
        public float? AvgMirrorOverheadLatency { get; set; }

        /// <summary>
        /// Total mirror write operations per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Total mirror write operations per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.</value>

        [DataMember(Name="mirror_write_iops")]
        public float? MirrorWriteIops { get; set; }

        /// <summary>
        /// Metro write rate in bytes per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Metro write rate in bytes per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByVg {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByVg)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByVg instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByVg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByVg other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByVg left, BasePerformanceMetricsByVg right)
        {

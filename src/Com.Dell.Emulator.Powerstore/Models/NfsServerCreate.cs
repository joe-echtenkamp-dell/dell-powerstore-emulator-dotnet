...
{ 
    /// <summary>
    /// Arguments for the NFS server create operation.
    /// </summary>
    [DataContract]
    public partial class NfsServerCreate : IEquatable<NfsServerCreate>
    { 
        /// <summary>
        /// Unique identifier of the NAS server. name:{name} can be used instead of {id}. For example: &#39;nas_server_id&#39;:&#39;name:nas_server_name&#39;
        /// </summary>
        /// <value>Unique identifier of the NAS server. name:{name} can be used instead of {id}. For example: &#39;nas_server_id&#39;:&#39;name:nas_server_name&#39;</value>
        [Required]
        ...
        /// </summary>
        /// <value>Indicates whether NFSv3 is enabled on the NAS server. When enabled, NFS shares can be accessed with NFSv3. When disabled, NFS shares can not be accessed with NFSv3 protocol. - true - NFSv3 is enabled on the specified NAS server. - false - NFSv3 is disabled on the specified NAS server. </value>
        ...
        /// </summary>
        /// <value>Indicates whether NFSv4 is enabled on the NAS server. When enabled, NFS shares can be accessed with NFSv4. When disabled, NFS shares can not be accessed with NFSv4 protocol. - true - NFSv4 is enabled on the specified NAS server. - false - NFSv4 is disabled on the specified NAS server. </value>
        ...
        /// </summary>
        /// <value>Sets the Time-To-Live (in minutes) expiration time in minutes for a Windows entry in the credentials cache. When failed mapping entries expire, the system retries mapping the UID to the SID.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfsServerCreate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((NfsServerCreate)obj);
        }

        /// <summary>
        /// Returns true if NfsServerCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of NfsServerCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfsServerCreate other)
        {
        ...
        public static bool operator ==(NfsServerCreate left, NfsServerCreate right)
        {

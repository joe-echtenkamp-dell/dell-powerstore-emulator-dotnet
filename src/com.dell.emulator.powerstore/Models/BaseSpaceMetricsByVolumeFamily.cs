...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BaseSpaceMetricsByVolumeFamily : IEquatable<BaseSpaceMetricsByVolumeFamily>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Amount of data in bytes host has written to a volume family without any deduplication, compression or sharing. This metric includes primaries, snaps and clones.</value>
        ...
        /// </summary>
        /// <value>Amount of physical space volume family used after compression and deduplication. This is the space to be freed up if a volume family is removed from the appliance.</value>
        ...
        /// <summary>
        /// Total Amount of data in bytes host has written to all volumes in the volume family without any deduplication, compression or sharing. This metric includes snaps and clones in the volume family.
        /// </summary>
        /// <value>Total Amount of data in bytes host has written to all volumes in the volume family without any deduplication, compression or sharing. This metric includes snaps and clones in the volume family.</value>
        ...
        /// <summary>
        /// Ratio of the amount of space that would have been used by snapshots if space efficiency was not applied to logical space used solely by snapshots. For example, a volume is provisioned as 1 GB bytes and it has two snapshots. Each snapshot has 200 MB of data. Snapshot savings will be (1 GB + 1 GB) / (0.2 GB + 0.2 GB) or 5:1. The snapshot_savings value will be 5 in this case.
        /// </summary>
        /// <value>Ratio of the amount of space that would have been used by snapshots if space efficiency was not applied to logical space used solely by snapshots. For example, a volume is provisioned as 1 GB bytes and it has two snapshots. Each snapshot has 200 MB of data. Snapshot savings will be (1 GB + 1 GB) / (0.2 GB + 0.2 GB) or 5:1. The snapshot_savings value will be 5 in this case.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseSpaceMetricsByVolumeFamily {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseSpaceMetricsByVolumeFamily)obj);
        }

        /// <summary>
        /// Returns true if BaseSpaceMetricsByVolumeFamily instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseSpaceMetricsByVolumeFamily to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseSpaceMetricsByVolumeFamily other)
        {
        ...
        public static bool operator ==(BaseSpaceMetricsByVolumeFamily left, BaseSpaceMetricsByVolumeFamily right)
        {

...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FlrModify : IEquatable<FlrModify>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether to automatically lock files in an FLR-enabled file system. When true files are locked automatically after modification based on the flrPolicyInterval interval. When enabled, auto-locked files are set with the default retention period value. This setting can only be applied to mounted FLR enabled file systems. </value>
        ...
        /// </summary>
        /// <value>Indicates whether locked files will be automatically delete from an FLR-enabled file system once their retention periods have expired. This setting can only be applied to mounted FLR enabled file systems. </value>
        ...
        /// </summary>
        /// <value>Indicates how long to wait (in seconds) after files are modified before the files are automatically locked. This setting can only be applied to mounted FLR enabled file systems. </value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FlrModify)obj);
        }

        /// <summary>
        /// Returns true if FlrModify instances are equal
        /// </summary>
        /// <param name="other">Instance of FlrModify to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlrModify other)
        {
        ...
        public static bool operator ==(FlrModify left, FlrModify right)
        {

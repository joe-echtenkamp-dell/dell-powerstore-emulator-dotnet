...
{ 
    /// <summary>
    /// Summary of cluster level file performance metric for the period beginning with timestamp, including the average and maximum values for that period.  Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsFileByClusterRollup : IEquatable<BasePerformanceMetricsFileByClusterRollup>
    { 
        /// <summary>
        /// Unique identifier of the cluster. Was added in version 3.0.0.0.
        /// </summary>
        /// <value>Unique identifier of the cluster. Was added in version 3.0.0.0.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsFileByClusterRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsFileByClusterRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsFileByClusterRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsFileByClusterRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsFileByClusterRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsFileByClusterRollup left, BasePerformanceMetricsFileByClusterRollup right)
        {

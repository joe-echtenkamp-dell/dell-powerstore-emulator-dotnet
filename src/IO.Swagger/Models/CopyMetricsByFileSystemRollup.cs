...
{ 
    /// <summary>
    /// Cluster wide copy metrics for the file system. Was added in version 4.0.0.0.
    /// </summary>
    [DataContract]
    public partial class CopyMetricsByFileSystemRollup : MetricsGenerateResponse, IEquatable<CopyMetricsByFileSystemRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CopyMetricsByFileSystemRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CopyMetricsByFileSystemRollup)obj);
        }

        /// <summary>
        /// Returns true if CopyMetricsByFileSystemRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of CopyMetricsByFileSystemRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CopyMetricsByFileSystemRollup other)
        {
        ...
        public static bool operator ==(CopyMetricsByFileSystemRollup left, CopyMetricsByFileSystemRollup right)
        {

...
{ 
    /// <summary>
    /// Summary of ip port (total) performance metric data for various rollup intervals beginning with timestamp, including the average and maximum values for that period. Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByIpPortRollup : IEquatable<BasePerformanceMetricsByIpPortRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByIpPortRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByIpPortRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByIpPortRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByIpPortRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByIpPortRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByIpPortRollup left, BasePerformanceMetricsByIpPortRollup right)
        {

...
{ 
    /// <summary>
    /// Arguments to an mfa_securid create operation. Was added in version 3.5.0.0.
    /// </summary>
    [DataContract]
    public partial class MfaSecuridCreate : IEquatable<MfaSecuridCreate>
    { 
        /// <summary>
        ...
        /// <summary>
        /// Access Key associated with RSA SecurID Authentication API. This value is passed in as the &#39;client-key&#39; REST header to the RSA authentication manager.
        /// </summary>
        /// <value>Access Key associated with RSA SecurID Authentication API. This value is passed in as the &#39;client-key&#39; REST header to the RSA authentication manager.</value>
        [Required]
        ...
        /// <summary>
        /// The PEM-encoded CA certificate for validating SSL communication with the SecurID service. This is a convenience argument that takes the place of using x509-certificates create, and setting the service to SECURID_HTTP, and scope to the id of this instance. 
        /// </summary>
        /// <value>The PEM-encoded CA certificate for validating SSL communication with the SecurID service. This is a convenience argument that takes the place of using x509-certificates create, and setting the service to SECURID_HTTP, and scope to the id of this instance. </value>
        [Required]
        
        [DataMember(Name="ca_certificate")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaSecuridCreate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MfaSecuridCreate)obj);
        }

        /// <summary>
        /// Returns true if MfaSecuridCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of MfaSecuridCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaSecuridCreate other)
        {
            ...
            return 
                ...
                (
                    ...
                    CaCertificate != null &&
                    CaCertificate.Equals(other.CaCertificate)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CaCertificate.GetHashCode();
        ...
        public static bool operator ==(MfaSecuridCreate left, MfaSecuridCreate right)
        {

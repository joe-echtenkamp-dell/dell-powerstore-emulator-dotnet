...
{ 
    /// <summary>
    /// Summary of aggregate user virtual machines CPU and memory utilization on appliance beginning with timestamp, including the average values for that period.  Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseVsphereAppsonMetricsByAppliance : IEquatable<BaseVsphereAppsonMetricsByAppliance>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseVsphereAppsonMetricsByAppliance {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseVsphereAppsonMetricsByAppliance)obj);
        }

        /// <summary>
        /// Returns true if BaseVsphereAppsonMetricsByAppliance instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseVsphereAppsonMetricsByAppliance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseVsphereAppsonMetricsByAppliance other)
        {
        ...
        public static bool operator ==(BaseVsphereAppsonMetricsByAppliance left, BaseVsphereAppsonMetricsByAppliance right)
        {

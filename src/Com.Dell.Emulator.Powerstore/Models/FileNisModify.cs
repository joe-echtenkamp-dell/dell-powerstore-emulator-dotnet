...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FileNisModify : IEquatable<FileNisModify>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>A new list of NIS server IP addresses to replace the existing list. The addresses may be IPv4 or IPv6.</value>
        ...
        /// </summary>
        /// <value>IP addresses to add to the current list. The addresses may be IPv4 or IPv6. Error occurs if the IP address already exists. Cannot be combined with ip_addresses.</value>
        ...
        /// </summary>
        /// <value>IP addresses to remove from the current list. The addresses may be IPv4 or IPv6. Error occurs if the IP address is not present. Cannot be combined with ip_addresses.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FileNisModify)obj);
        }

        /// <summary>
        /// Returns true if FileNisModify instances are equal
        /// </summary>
        /// <param name="other">Instance of FileNisModify to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileNisModify other)
        {
        ...
        public static bool operator ==(FileNisModify left, FileNisModify right)
        {

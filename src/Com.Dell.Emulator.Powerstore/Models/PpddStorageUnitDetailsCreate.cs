...
{ 
    /// <summary>
    /// PowerProtect DD details to register with Powerstore as a remote system.  Was added in version 3.5.0.0.
    /// </summary>
    [DataContract]
    public partial class PpddStorageUnitDetailsCreate : IEquatable<PpddStorageUnitDetailsCreate>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Password used to access the  storage unit of a PowerProtect DD remote system. </value>
        [Required]
        
        [DataMember(Name="dd_boost_password")]
        public string DdBoostPassword { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PpddStorageUnitDetailsCreate {\n");
            ...
            sb.Append("  DdBoostPassword: ").Append(DdBoostPassword).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PpddStorageUnitDetailsCreate)obj);
        }

        /// <summary>
        /// Returns true if PpddStorageUnitDetailsCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of PpddStorageUnitDetailsCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PpddStorageUnitDetailsCreate other)
        {
            ...
            return 
                ...
                (
                    DdBoostPassword == other.DdBoostPassword ||
                    DdBoostPassword != null &&
                    DdBoostPassword.Equals(other.DdBoostPassword)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (DdBoostPassword != null)
                    hashCode = hashCode * 59 + DdBoostPassword.GetHashCode();
        ...
        public static bool operator ==(PpddStorageUnitDetailsCreate left, PpddStorageUnitDetailsCreate right)
        {

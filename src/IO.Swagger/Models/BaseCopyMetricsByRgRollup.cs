...
{ 
    /// <summary>
    /// Cluster wide copy metrics for the replication group. Was added in version 3.5.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseCopyMetricsByRgRollup : IEquatable<BaseCopyMetricsByRgRollup>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Unique identifier of the replication group.</value>

        [DataMember(Name="rg_id")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseCopyMetricsByRgRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseCopyMetricsByRgRollup)obj);
        }

        /// <summary>
        /// Returns true if BaseCopyMetricsByRgRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseCopyMetricsByRgRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCopyMetricsByRgRollup other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (RgId != null)
                    hashCode = hashCode * 59 + RgId.GetHashCode();
        ...
        public static bool operator ==(BaseCopyMetricsByRgRollup left, BaseCopyMetricsByRgRollup right)
        {

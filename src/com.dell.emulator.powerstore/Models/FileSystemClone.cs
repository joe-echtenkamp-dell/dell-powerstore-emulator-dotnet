...
{ 
    /// <summary>
    /// Parameters for the file system clone operation.
    /// </summary>
    [DataContract]
    public partial class FileSystemClone : IEquatable<FileSystemClone>
    { 
        /// <summary>
        /// Name of the clone.
        /// </summary>
        /// <value>Name of the clone.</value>
        [Required]
        ...
        /// </summary>
        /// <value>Description of the clone.</value>
        ...
        /// </summary>
        /// <value>Indicates if opportunistic file locking is enabled on the file system. Values are: * true - Opportunistic file locking is enabled on the file system. * false - Opportunistic file locking is disabled on the file system. </value>
        ...
        /// </summary>
        /// <value>Indicates whether file access notifications are enabled on the file system. Values are: * true - File system notifications are enabled on the file system. * false - File system notifications are disabled on the file system. </value>
        ...
        public FlrClone FlrAttributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileSystemClone {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FileSystemClone)obj);
        }

        /// <summary>
        /// Returns true if FileSystemClone instances are equal
        /// </summary>
        /// <param name="other">Instance of FileSystemClone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileSystemClone other)
        {
        ...
        public static bool operator ==(FileSystemClone left, FileSystemClone right)
        {

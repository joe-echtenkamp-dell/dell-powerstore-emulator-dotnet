...
{ 
    /// <summary>
    /// Wear metrics for the drives collected at twenty second interval. Was deprecated in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseWearMetricsByDriveInstance : IEquatable<BaseWearMetricsByDriveInstance>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseWearMetricsByDriveInstance {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseWearMetricsByDriveInstance)obj);
        }

        /// <summary>
        /// Returns true if BaseWearMetricsByDriveInstance instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseWearMetricsByDriveInstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseWearMetricsByDriveInstance other)
        {
        ...
        public static bool operator ==(BaseWearMetricsByDriveInstance left, BaseWearMetricsByDriveInstance right)
        {

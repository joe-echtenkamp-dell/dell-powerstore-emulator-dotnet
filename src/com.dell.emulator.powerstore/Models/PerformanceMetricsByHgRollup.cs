...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsByHgRollup : MetricsGenerateResponse, IEquatable<PerformanceMetricsByHgRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsByHgRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsByHgRollup)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsByHgRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsByHgRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsByHgRollup other)
        {
        ...
        public static bool operator ==(PerformanceMetricsByHgRollup left, PerformanceMetricsByHgRollup right)
        {

...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsByFeEthPortRollup : MetricsGenerateResponse, IEquatable<PerformanceMetricsByFeEthPortRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsByFeEthPortRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsByFeEthPortRollup)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsByFeEthPortRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsByFeEthPortRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsByFeEthPortRollup other)
        {
        ...
        public static bool operator ==(PerformanceMetricsByFeEthPortRollup left, PerformanceMetricsByFeEthPortRollup right)
        {

...
{ 
    /// <summary>
    /// Space metrics for the VM collected at five minute interval.
    /// </summary>
    [DataContract]
    public partial class BaseSpaceMetricsByVm : IEquatable<BaseSpaceMetricsByVm>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Total configured size in bytes of all virtual volumes used by virtual machine.</value>
        ...
        /// </summary>
        /// <value>Total amount of data in bytes written to all virtual volumes used by virtual machine.</value>
        ...
        /// </summary>
        /// <value>Amount of physical space virtual machine used after compression and deduplication. This is the space to be freed up if a virtual machine is removed.</value>
        ...
        /// <summary>
        /// Total amount of data in bytes host has written to all volumes used by virtual machine without any deduplication, compression or sharing. This metric includes snaps and clones in the volume family used by virtual machine.
        /// </summary>
        /// <value>Total amount of data in bytes host has written to all volumes used by virtual machine without any deduplication, compression or sharing. This metric includes snaps and clones in the volume family used by virtual machine.</value>
        ...
        /// <summary>
        /// Ratio of all the vVol provisioned to data they contain. This is the ratio of logical_provisioned to logical_used. For example, a VM has two 2 GB vVol&#39;s and have written 500 MB of data to them. The thin savings would be (2 * 2GB) / (2 * 0.5 GB) or 4:1, so the thin_savings value would be 4.0.
        /// </summary>
        /// <value>Ratio of all the vVol provisioned to data they contain. This is the ratio of logical_provisioned to logical_used. For example, a VM has two 2 GB vVol&#39;s and have written 500 MB of data to them. The thin savings would be (2 * 2GB) / (2 * 0.5 GB) or 4:1, so the thin_savings value would be 4.0.</value>

        [DataMember(Name="thin_savings")]
        public float? ThinSavings { get; set; }

        /// <summary>
        /// Ratio of the amount of space that would have been used by snapshots if space efficiency was not applied to logical space used solely by snapshots of vVols used by virtual machine. For example, a vVol is provisioned as 1 GB and it has two snapshots. Each snapshot has 200 MB of data. Snapshot savings will be (1 GB + 1 GB) / (0.2 GB + 0.2 GB) or 5:1. The snapshot_savings value will be 5 in this case.
        /// </summary>
        /// <value>Ratio of the amount of space that would have been used by snapshots if space efficiency was not applied to logical space used solely by snapshots of vVols used by virtual machine. For example, a vVol is provisioned as 1 GB and it has two snapshots. Each snapshot has 200 MB of data. Snapshot savings will be (1 GB + 1 GB) / (0.2 GB + 0.2 GB) or 5:1. The snapshot_savings value will be 5 in this case.</value>

        [DataMember(Name="snapshot_savings")]
        public float? SnapshotSavings { get; set; }

        /// <summary>
        /// Amount of space the virtual machine needs to hold the data written by host and shared by snaps and fast-clones in their families. This does not include deduplication or compression. Was added in version 3.5.0.0.
        /// </summary>
        /// <value>Amount of space the virtual machine needs to hold the data written by host and shared by snaps and fast-clones in their families. This does not include deduplication or compression. Was added in version 3.5.0.0.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseSpaceMetricsByVm {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseSpaceMetricsByVm)obj);
        }

        /// <summary>
        /// Returns true if BaseSpaceMetricsByVm instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseSpaceMetricsByVm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseSpaceMetricsByVm other)
        {
        ...
        public static bool operator ==(BaseSpaceMetricsByVm left, BaseSpaceMetricsByVm right)
        {

...
{ 
    /// <summary>
    /// Information about an LDAP domain. Was added in version 1.0.3.
    /// </summary>
    [DataContract]
    public partial class LdapDomainInstance : IEquatable<LdapDomainInstance>
    { 
        /// <summary>
        /// Unique identifier of the new LDAP server configuration.
        /// </summary>
        /// <value>Unique identifier of the new LDAP server configuration.</value>
        ...
        /// </summary>
        /// <value>Name of the LDAP authority to construct the LDAP server configuration.</value>
        ...
        /// <summary>
        /// Port number used to connect to the LDAP server(s). Default values are LDAP(389), LDAPs(636), GlobalCatalog LDAP(3268), Global Catalog LDAPs(3269).
        /// </summary>
        /// <value>Port number used to connect to the LDAP server(s). Default values are LDAP(389), LDAPs(636), GlobalCatalog LDAP(3268), Global Catalog LDAPs(3269).</value>
        ...
        /// </summary>
        /// <value>Path used to search for users on the directory server.</value>
        ...
        /// </summary>
        /// <value>Path used to search for groups on the directory server.</value>
        ...
        /// <summary>
        /// Localized message string corresponding to ldap_server_type Was added in version 1.0.3.
        /// </summary>
        /// <value>Localized message string corresponding to ldap_server_type Was added in version 1.0.3.</value>

        [DataMember(Name="ldap_server_type_l10n")]
        public string LdapServerTypeL10n { get; set; }

        /// <summary>
        /// Localized message string corresponding to protocol Was added in version 1.0.3.
        /// </summary>
        /// <value>Localized message string corresponding to protocol Was added in version 1.0.3.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LdapDomainInstance {\n");
            ...
            sb.Append("  LdapServerTypeL10n: ").Append(LdapServerTypeL10n).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((LdapDomainInstance)obj);
        }

        /// <summary>
        /// Returns true if LdapDomainInstance instances are equal
        /// </summary>
        /// <param name="other">Instance of LdapDomainInstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LdapDomainInstance other)
        {
            ...
            return 
                ...
                (
                    LdapServerTypeL10n == other.LdapServerTypeL10n ||
                    LdapServerTypeL10n != null &&
                    LdapServerTypeL10n.Equals(other.LdapServerTypeL10n)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (LdapServerTypeL10n != null)
                    hashCode = hashCode * 59 + LdapServerTypeL10n.GetHashCode();
        ...
        public static bool operator ==(LdapDomainInstance left, LdapDomainInstance right)
        {

...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FileInterfaceCreate : IEquatable<FileInterfaceCreate>
    { 
        /// <summary>
        /// Unique identifier of the NAS server to which the network interface belongs, as defined by the nas_server resource type. name:{name} can be used instead of {id}. For example: &#39;nas_server_id&#39;:&#39;name:nas_server_name&#39;
        /// </summary>
        /// <value>Unique identifier of the NAS server to which the network interface belongs, as defined by the nas_server resource type. name:{name} can be used instead of {id}. For example: &#39;nas_server_id&#39;:&#39;name:nas_server_name&#39;</value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileInterfaceCreate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FileInterfaceCreate)obj);
        }

        /// <summary>
        /// Returns true if FileInterfaceCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of FileInterfaceCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileInterfaceCreate other)
        {
        ...
        public static bool operator ==(FileInterfaceCreate left, FileInterfaceCreate right)
        {

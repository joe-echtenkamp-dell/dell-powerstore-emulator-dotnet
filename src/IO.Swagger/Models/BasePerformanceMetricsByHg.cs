...
{ 
    /// <summary>
    /// Performance metrics for the host group collected at twenty second interval. Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByHg : IEquatable<BasePerformanceMetricsByHg>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByHg {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByHg)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByHg instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByHg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByHg other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByHg left, BasePerformanceMetricsByHg right)
        {

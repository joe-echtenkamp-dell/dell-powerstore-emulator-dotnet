...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsBySmbV1Node : IEquatable<BasePerformanceMetricsBySmbV1Node>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsBySmbV1Node {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsBySmbV1Node)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsBySmbV1Node instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsBySmbV1Node to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsBySmbV1Node other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsBySmbV1Node left, BasePerformanceMetricsBySmbV1Node right)
        {

...
{ 
    /// <summary>
    /// Summary of ip port (iSCSI) performance metric data for various rollup intervals beginning with timestamp, including the average and maximum values for that period. Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByIpPortIscsiRollup : IEquatable<BasePerformanceMetricsByIpPortIscsiRollup>
    { 
        /// <summary>
        /// Unique identifier representing a specific port.
        /// </summary>
        /// <value>Unique identifier representing a specific port.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByIpPortIscsiRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByIpPortIscsiRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByIpPortIscsiRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByIpPortIscsiRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByIpPortIscsiRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByIpPortIscsiRollup left, BasePerformanceMetricsByIpPortIscsiRollup right)
        {

...
{ 
    /// <summary>
    /// Summary of file level performance metric data per appliance for the period beginning with timestamp, including the average and maximum values for that period.  Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsFileByApplianceRollup : IEquatable<BasePerformanceMetricsFileByApplianceRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsFileByApplianceRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsFileByApplianceRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsFileByApplianceRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsFileByApplianceRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsFileByApplianceRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsFileByApplianceRollup left, BasePerformanceMetricsFileByApplianceRollup right)
        {

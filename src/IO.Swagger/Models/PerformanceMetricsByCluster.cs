...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsByCluster : MetricsGenerateResponse, IEquatable<PerformanceMetricsByCluster>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsByCluster {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsByCluster)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsByCluster instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsByCluster to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsByCluster other)
        {
        ...
        public static bool operator ==(PerformanceMetricsByCluster left, PerformanceMetricsByCluster right)
        {

...
{ 
    /// <summary>
    /// Parameters for file FTP create operation.
    /// </summary>
    [DataContract]
    public partial class FileFtpCreate : IEquatable<FileFtpCreate>
    { 
        /// <summary>
        /// Unique identifier of the NAS server that is configured with the FTP server. name:{name} can be used instead of {id}. For example: &#39;nas_server_id&#39;:&#39;name:nas_server_name&#39;
        /// </summary>
        /// <value>Unique identifier of the NAS server that is configured with the FTP server. name:{name} can be used instead of {id}. For example: &#39;nas_server_id&#39;:&#39;name:nas_server_name&#39;</value>
        [Required]
        ...
        /// </summary>
        /// <value>(Applies when the value of is_homedir_limit_enabled is false.) Default directory of FTP and SFTP clients who have a home directory that is not defined or accessible.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FileFtpCreate)obj);
        }

        /// <summary>
        /// Returns true if FileFtpCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of FileFtpCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileFtpCreate other)
        {
        ...
        public static bool operator ==(FileFtpCreate left, FileFtpCreate right)
        {

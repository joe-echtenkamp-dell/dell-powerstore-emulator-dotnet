...
{ 
    ...
    { 
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EsxiCredentials {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EsxiCredentials)obj);
        }

        /// <summary>
        /// Returns true if EsxiCredentials instances are equal
        /// </summary>
        /// <param name="other">Instance of EsxiCredentials to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EsxiCredentials other)
        {

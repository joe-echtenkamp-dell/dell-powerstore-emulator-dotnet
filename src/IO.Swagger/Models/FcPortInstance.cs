...
{ 
    /// <summary>
    /// Properties of the FC front-end port. Values was added in 2.0.0.0: wwn_nvme. Values was added in 3.0.0.0: is_in_use. This resource type has queriable associations from appliance, hardware, fc_port
    /// </summary>
    [DataContract]
    public partial class FcPortInstance : IEquatable<FcPortInstance>
    { 
        /// <summary>
        /// Unique identifier of the port.
        /// </summary>
        /// <value>Unique identifier of the port.</value>
        ...
        /// </summary>
        /// <value>Name of the port.  This property supports case-insensitive filtering.</value>
        ...
        /// </summary>
        /// <value>World Wide Name (WWN) of the port.  More specifically, it&#39;s the World Wide Port Name (WWPN) used for SCSI Protocol.</value>
        ...
        /// </summary>
        /// <value>World Wide Name (WWN) of NVME port. Was added in version 2.0.0.0.</value>

        [DataMember(Name="wwn_nvme")]
        public string WwnNvme { get; set; }
        ...
        /// </summary>
        /// <value>World Wide Name (WWN) of the Node of the port.  More specifically, it&#39;s the World Wide Node Name (WWNN). Was added in version 3.0.0.0.</value>

        [DataMember(Name="wwn_node")]
        public string WwnNode { get; set; }

        /// <summary>
        /// Indicates whether the port&#39;s link is up. Values are: * true - Link is up. * false - Link is down. 
        /// </summary>
        /// <value>Indicates whether the port&#39;s link is up. Values are: * true - Link is up. * false - Link is down. </value>
        ...
        /// </summary>
        /// <value>List of supported transmission speeds for the port.</value>

        [DataMember(Name="supported_speeds")]
        public List<FcPortSpeedEnum> SupportedSpeeds { get; set; }
        ...
        public FcPortSpeedEnum? CurrentSpeed { get; set; }
        ...
        public FcPortSpeedEnum? RequestedSpeed { get; set; }
        ...
        /// </summary>
        /// <value>Unique identifier of the parent hardware instance handling the port. @added(Foothills) Was added in version 2.0.0.0.</value>
        ...
        /// </summary>
        /// <value>Index of the port in the IO module.</value>
        ...
        /// </summary>
        /// <value>Unique identifier of the partner port.</value>
        ...
        /// </summary>
        /// <value>List of supported protocols for the port. Was added in version 2.0.0.0.</value>

        [DataMember(Name="protocols")]
        public List<FcPortProtocolEnum> Protocols { get; set; }
        ...
        [DataMember(Name="scsi_mode")]
        public FcPortScsiModeEnum? ScsiMode { get; set; }
        ...
        /// </summary>
        /// <value>Localized message array corresponding to protocols Was added in version 2.0.0.0.</value>
        ...
        /// </summary>
        /// <value>Localized message string corresponding to scsi_mode Was added in version 3.0.0.0.</value>

        [DataMember(Name="scsi_mode_l10n")]
        public string ScsiModeL10n { get; set; }
        ...
        public FcPortInstance Partner { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FcPortInstance {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  ApplianceId: ").Append(ApplianceId).Append("\n");
            sb.Append("  NodeId: ").Append(NodeId).Append("\n");
            sb.Append("  Wwn: ").Append(Wwn).Append("\n");
            sb.Append("  WwnNvme: ").Append(WwnNvme).Append("\n");
            sb.Append("  WwnNode: ").Append(WwnNode).Append("\n");
            ...
            sb.Append("  ScsiMode: ").Append(ScsiMode).Append("\n");
            ...
            sb.Append("  ScsiModeL10n: ").Append(ScsiModeL10n).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FcPortInstance)obj);
        }

        /// <summary>
        /// Returns true if FcPortInstance instances are equal
        /// </summary>
        /// <param name="other">Instance of FcPortInstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FcPortInstance other)
        {
            ...
            return 
                ...
                (
                    WwnNvme == other.WwnNvme ||
                    WwnNvme != null &&
                    WwnNvme.Equals(other.WwnNvme)
                ) && 
                (
                    WwnNode == other.WwnNode ||
                    WwnNode != null &&
                    WwnNode.Equals(other.WwnNode)
                ) && 
                (
                ...
                (
                    ScsiMode == other.ScsiMode ||
                    ScsiMode != null &&
                    ScsiMode.Equals(other.ScsiMode)
                ) && 
                (
                ...
                (
                    ScsiModeL10n == other.ScsiModeL10n ||
                    ScsiModeL10n != null &&
                    ScsiModeL10n.Equals(other.ScsiModeL10n)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (WwnNvme != null)
                    hashCode = hashCode * 59 + WwnNvme.GetHashCode();
                    if (WwnNode != null)
                    hashCode = hashCode * 59 + WwnNode.GetHashCode();
                    if (IsLinkUp != null)
                    ...
                    if (ScsiMode != null)
                    hashCode = hashCode * 59 + ScsiMode.GetHashCode();
                    ...
                    if (ScsiModeL10n != null)
                    hashCode = hashCode * 59 + ScsiModeL10n.GetHashCode();
                    if (Appliance != null)
        ...
        public static bool operator ==(FcPortInstance left, FcPortInstance right)
        {

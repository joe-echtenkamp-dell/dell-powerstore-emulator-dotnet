...
{ 
    /// <summary>
    /// Arguments for the SMB server create operation. ***Note that domain SMB servers must be explicitly joined to the Active Directory using the join action before it can be accessed*** To create a standalone SMB server, set the is_standalone option to true and specify the following mandatory parameters:   - netbios_name   - workgroup For domain SMB servers, set the is_standalone option to false and specify the following mandatory parameters:   - computer_name   - domain For both cases, you must also specify a password for the local administrator of the SMB server using the local_admin_password option. 
    /// </summary>
    [DataContract]
    public partial class SmbServerCreate : IEquatable<SmbServerCreate>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Regardless of the type of the SMB server, standalone or in the domain, a local administrator user must be created. local_admin_password is the password of this user. ***Note The maximum length of a password that a human user could actually type to log into Windows is 127 characters (the limitation is in the Windows GUI).*** </value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SmbServerCreate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SmbServerCreate)obj);
        }

        /// <summary>
        /// Returns true if SmbServerCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of SmbServerCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmbServerCreate other)
        {
        ...
        public static bool operator ==(SmbServerCreate left, SmbServerCreate right)
        {

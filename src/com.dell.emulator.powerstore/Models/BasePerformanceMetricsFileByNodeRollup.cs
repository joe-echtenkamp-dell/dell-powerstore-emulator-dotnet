...
{ 
    /// <summary>
    /// Summary of file level performance metric data per node for the period beginning with timestamp, including the average and maximum values for that period.  Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsFileByNodeRollup : IEquatable<BasePerformanceMetricsFileByNodeRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsFileByNodeRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsFileByNodeRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsFileByNodeRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsFileByNodeRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsFileByNodeRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsFileByNodeRollup left, BasePerformanceMetricsFileByNodeRollup right)
        {

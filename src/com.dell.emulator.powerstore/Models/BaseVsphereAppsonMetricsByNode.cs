...
{ 
    /// <summary>
    /// Summary of aggregate user virtual machines CPU and memory utilization on node beginning with timestamp, including the average values for that period.  Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseVsphereAppsonMetricsByNode : IEquatable<BaseVsphereAppsonMetricsByNode>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseVsphereAppsonMetricsByNode {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseVsphereAppsonMetricsByNode)obj);
        }

        /// <summary>
        /// Returns true if BaseVsphereAppsonMetricsByNode instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseVsphereAppsonMetricsByNode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseVsphereAppsonMetricsByNode other)
        {
        ...
        public static bool operator ==(BaseVsphereAppsonMetricsByNode left, BaseVsphereAppsonMetricsByNode right)
        {

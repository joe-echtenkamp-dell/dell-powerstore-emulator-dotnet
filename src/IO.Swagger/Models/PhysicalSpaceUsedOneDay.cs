...
{ 
    /// <summary>
    /// Response for appliance capacity based forecast. Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class PhysicalSpaceUsedOneDay : ApplianceForecastResponse, IEquatable<PhysicalSpaceUsedOneDay>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PhysicalSpaceUsedOneDay {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PhysicalSpaceUsedOneDay)obj);
        }

        /// <summary>
        /// Returns true if PhysicalSpaceUsedOneDay instances are equal
        /// </summary>
        /// <param name="other">Instance of PhysicalSpaceUsedOneDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhysicalSpaceUsedOneDay other)
        {
        ...
        public static bool operator ==(PhysicalSpaceUsedOneDay left, PhysicalSpaceUsedOneDay right)
        {

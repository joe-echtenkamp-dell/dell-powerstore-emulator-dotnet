...
{ 
    /// <summary>
    /// Copy metrics for the cluster. Was added in version 3.5.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseCopyMetricsByClusterRollup : IEquatable<BaseCopyMetricsByClusterRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseCopyMetricsByClusterRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseCopyMetricsByClusterRollup)obj);
        }

        /// <summary>
        /// Returns true if BaseCopyMetricsByClusterRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseCopyMetricsByClusterRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCopyMetricsByClusterRollup other)
        {
        ...
        public static bool operator ==(BaseCopyMetricsByClusterRollup left, BaseCopyMetricsByClusterRollup right)
        {

...
{ 
    /// <summary>
    /// Performance metrics for the hosts in a host group collected at twenty second interval. Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsByHg : MetricsGenerateResponse, IEquatable<PerformanceMetricsByHg>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsByHg {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsByHg)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsByHg instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsByHg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsByHg other)
        {
        ...
        public static bool operator ==(PerformanceMetricsByHg left, PerformanceMetricsByHg right)
        {

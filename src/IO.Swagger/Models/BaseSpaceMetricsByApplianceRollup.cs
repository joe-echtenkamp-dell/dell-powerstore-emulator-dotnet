...
{ 
    /// <summary>
    /// Summary of appliance level space metric data for a specific period of time, beginning with timestamp and including the maximum and final values for that period. Current support is for a time period of one hour and one day.
    /// </summary>
    [DataContract]
    public partial class BaseSpaceMetricsByApplianceRollup : IEquatable<BaseSpaceMetricsByApplianceRollup>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Maxiumum logical total space during the period.</value>
        ...
        /// </summary>
        /// <value>Maxiumum logical used space during the period.</value>
        ...
        /// <summary>
        /// Maximum shared logical used space for file volumes during the period. Was added in version 2.0.0.0.
        /// </summary>
        /// <value>Maximum shared logical used space for file volumes during the period. Was added in version 2.0.0.0.</value>
        ...
        /// </summary>
        /// <value>Max shared logical used during the period.</value>
        ...
        /// <summary>
        /// Maximum reducible data reduction ratio during the period. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Maximum reducible data reduction ratio during the period. Was added in version 4.0.0.0.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseSpaceMetricsByApplianceRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseSpaceMetricsByApplianceRollup)obj);
        }

        /// <summary>
        /// Returns true if BaseSpaceMetricsByApplianceRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseSpaceMetricsByApplianceRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseSpaceMetricsByApplianceRollup other)
        {
        ...
        public static bool operator ==(BaseSpaceMetricsByApplianceRollup left, BaseSpaceMetricsByApplianceRollup right)
        {

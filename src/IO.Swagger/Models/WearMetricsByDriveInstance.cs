...
{ 
    /// <summary>
    /// Wear metrics for the drives collected at twenty second interval. Was added in version 1.0. Was deprecated in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class WearMetricsByDriveInstance : MetricsGenerateResponse, IEquatable<WearMetricsByDriveInstance>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WearMetricsByDriveInstance {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((WearMetricsByDriveInstance)obj);
        }

        /// <summary>
        /// Returns true if WearMetricsByDriveInstance instances are equal
        /// </summary>
        /// <param name="other">Instance of WearMetricsByDriveInstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WearMetricsByDriveInstance other)
        {
        ...
        public static bool operator ==(WearMetricsByDriveInstance left, WearMetricsByDriveInstance right)
        {

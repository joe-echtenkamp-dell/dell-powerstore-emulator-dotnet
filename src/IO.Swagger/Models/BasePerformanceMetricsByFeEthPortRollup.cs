...
{ 
    /// <summary>
    /// Performance metrics for the frontend ethernet port rolled up at various rollup intervals.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByFeEthPortRollup : IEquatable<BasePerformanceMetricsByFeEthPortRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByFeEthPortRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByFeEthPortRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByFeEthPortRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByFeEthPortRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByFeEthPortRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByFeEthPortRollup left, BasePerformanceMetricsByFeEthPortRollup right)
        {

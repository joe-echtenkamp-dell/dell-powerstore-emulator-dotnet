...
{ 
    /// <summary>
    /// Summary of virtual machine level performance metric data for various rollup intervals beginning with timestamp, including the average and maximum values for that period.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByVmRollup : IEquatable<BasePerformanceMetricsByVmRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByVmRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByVmRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByVmRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByVmRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByVmRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByVmRollup left, BasePerformanceMetricsByVmRollup right)
        {

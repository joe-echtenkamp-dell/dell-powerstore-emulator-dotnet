...
{ 
    /// <summary>
    /// Performance metrics for the file per node collected at twenty second interval.  Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsFileByNode : MetricsGenerateResponse, IEquatable<PerformanceMetricsFileByNode>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsFileByNode {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsFileByNode)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsFileByNode instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsFileByNode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsFileByNode other)
        {
        ...
        public static bool operator ==(PerformanceMetricsFileByNode left, PerformanceMetricsFileByNode right)
        {

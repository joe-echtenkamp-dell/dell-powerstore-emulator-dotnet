...
{ 
    /// <summary>
    /// Performance metrics for the frontend fibre channel port collected at twenty second interval.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByFeFcPort : IEquatable<BasePerformanceMetricsByFeFcPort>
    { 
        /// <summary>
        /// Reference to the associated frontend fibre channel port (fc_port) on which these metrics were recorded.
        /// </summary>
        /// <value>Reference to the associated frontend fibre channel port (fc_port) on which these metrics were recorded.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByFeFcPort {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByFeFcPort)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByFeFcPort instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByFeFcPort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByFeFcPort other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByFeFcPort left, BasePerformanceMetricsByFeFcPort right)
        {

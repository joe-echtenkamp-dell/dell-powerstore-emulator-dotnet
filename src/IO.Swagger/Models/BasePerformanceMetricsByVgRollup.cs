...
{ 
    /// <summary>
    /// Performance metrics of all volumes in a volume group aggregated at various rollup intervals. Was added in version 3.5.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByVgRollup : IEquatable<BasePerformanceMetricsByVgRollup>
    { 
        /// <summary>
        ...
        /// <summary>
        /// Weighted additional latency incurred on the source in order to do the remote mirror writes in microseconds. This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Weighted additional latency incurred on the source in order to do the remote mirror writes in microseconds. This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.</value>

        [DataMember(Name="avg_mirror_overhead_latency")]
        public float? AvgMirrorOverheadLatency { get; set; }

        /// <summary>
        /// Average mirror write operations per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Average mirror write operations per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.</value>

        [DataMember(Name="avg_mirror_write_iops")]
        public float? AvgMirrorWriteIops { get; set; }

        /// <summary>
        /// Weighted average mirror write rate in byte per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Weighted average mirror write rate in byte per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.</value>

        [DataMember(Name="avg_mirror_write_bandwidth")]
        public float? AvgMirrorWriteBandwidth { get; set; }

        /// <summary>
        /// Maximum of average additional latency incurred on the source in order to do the remote mirror writes in microseconds. This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Maximum of average additional latency incurred on the source in order to do the remote mirror writes in microseconds. This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.</value>

        [DataMember(Name="max_avg_mirror_overhead_latency")]
        public float? MaxAvgMirrorOverheadLatency { get; set; }

        /// <summary>
        /// Maximum mirror write operations per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Maximum mirror write operations per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.</value>

        [DataMember(Name="max_mirror_write_iops")]
        public float? MaxMirrorWriteIops { get; set; }

        /// <summary>
        /// Maximum mirror write rate in byte per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.
        /// </summary>
        /// <value>Maximum mirror write rate in byte per second.  This applies to metro volumes in the active-active state. Was added in version 4.0.0.0.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByVgRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByVgRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByVgRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByVgRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByVgRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByVgRollup left, BasePerformanceMetricsByVgRollup right)
        {

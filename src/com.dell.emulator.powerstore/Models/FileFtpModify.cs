...
{ 
    /// <summary>
    /// Parameters for file FTP modify operation.
    /// </summary>
    [DataContract]
    public partial class FileFtpModify : IEquatable<FileFtpModify>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether the FTP server is enabled on the NAS server specified in the nasServer attribute. Values are: - true - FTP server is enabled on the specified NAS server. - false - FTP server is disabled on the specified NAS server. </value>
        ...
        /// </summary>
        /// <value>Indicates whether the SFTP server is enabled on the NAS server specified in the nasServer attribute. Values are: - true - SFTP server is enabled on the specified NAS server. - false - SFTP server is disabled on the specified NAS server. </value>
        ...
        /// </summary>
        /// <value>Indicates whether an FTP or SFTP user access is limited to the home directory of the user. Values are: - true - An FTP or SFTP user can access only the home directory of the user. - false - FTP and SFTP users can access any NAS server directory, according to NAS server permissions. </value>
        ...
        /// </summary>
        /// <value>Host IP addresses to add to the current hosts. The addresses may be IPv4 or IPv6. Error occurs if the IP address already exists. Cannot be combined with hosts.</value>

        [DataMember(Name="add_hosts")]
        public List<string> AddHosts { get; set; }
        ...
        /// </summary>
        /// <value>Host IP addresses to remove from the current hosts. The addresses may be IPv4 or IPv6. Error occurs if the IP address is not present. Cannot be combined with hosts.</value>

        [DataMember(Name="remove_hosts")]
        public List<string> RemoveHosts { get; set; }
        ...
        /// </summary>
        /// <value>Allowed or denied users, depending on the value of the is_allowed_users attribute. - If allowed users exist, only those users and no others can connect to the NAS server through FTP or SFTP. - If denied users exist, they always have access denied to the NAS server through FTP or SFTP. - If the list is empty, there is no restriction to the NAS server access through FTP or SFTP based on the user name. </value>
        ...
        /// </summary>
        /// <value>Users to add to the current users. Error occurs if the user already exist. Cannot be combined with users.</value>
        ...
        /// </summary>
        /// <value>Users to remove from the current users. Error occurs if the user is not present. Cannot be combined with users.</value>
        ...
        /// </summary>
        /// <value>Groups to add to the current groups. Error occurs if the group already exists. Cannot be combined with groups.</value>

        [DataMember(Name="add_groups")]
        ...
        /// </summary>
        /// <value>Groups to remove from the current groups. Error occurs if the group is not present. Cannot be combined with groups.</value>

        [DataMember(Name="remove_groups")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RemoveHosts: ").Append(RemoveHosts).Append("\n");
            sb.Append("  Users: ").Append(Users).Append("\n");
            sb.Append("  AddUsers: ").Append(AddUsers).Append("\n");
            sb.Append("  RemoveUsers: ").Append(RemoveUsers).Append("\n");
            sb.Append("  Groups: ").Append(Groups).Append("\n");
            sb.Append("  AddGroups: ").Append(AddGroups).Append("\n");
            sb.Append("  RemoveGroups: ").Append(RemoveGroups).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FileFtpModify)obj);
        }

        /// <summary>
        /// Returns true if FileFtpModify instances are equal
        /// </summary>
        /// <param name="other">Instance of FileFtpModify to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileFtpModify other)
        {
            ...
            return 
                ...
                (
                    AddHosts == other.AddHosts ||
                    AddHosts != null &&
                    AddHosts.SequenceEqual(other.AddHosts)
                ) && 
                (
                    RemoveHosts == other.RemoveHosts ||
                    RemoveHosts != null &&
                    RemoveHosts.SequenceEqual(other.RemoveHosts)
                ) && 
                (
                    Users == other.Users ||
                    Users != null &&
                ...
                (
                    ...
                    AddUsers != null &&
                    AddUsers.SequenceEqual(other.AddUsers)
                ) && 
                (
                    RemoveUsers == other.RemoveUsers ||
                    RemoveUsers != null &&
                    RemoveUsers.SequenceEqual(other.RemoveUsers)
                ) && 
                (
                    Groups == other.Groups ||
                    Groups != null &&
                ...
                (
                    ...
                    AddGroups != null &&
                    AddGroups.SequenceEqual(other.AddGroups)
                ) && 
                (
                    RemoveGroups == other.RemoveGroups ||
                    RemoveGroups != null &&
                    RemoveGroups.SequenceEqual(other.RemoveGroups)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (AddHosts != null)
                    hashCode = hashCode * 59 + AddHosts.GetHashCode();
                    if (RemoveHosts != null)
                    hashCode = hashCode * 59 + RemoveHosts.GetHashCode();
                    if (Users != null)
                    hashCode = hashCode * 59 + Users.GetHashCode();
                    if (AddUsers != null)
                    hashCode = hashCode * 59 + AddUsers.GetHashCode();
                    if (RemoveUsers != null)
                    hashCode = hashCode * 59 + RemoveUsers.GetHashCode();
                    if (Groups != null)
                    hashCode = hashCode * 59 + Groups.GetHashCode();
                    if (AddGroups != null)
                    hashCode = hashCode * 59 + AddGroups.GetHashCode();
                    if (RemoveGroups != null)
                    hashCode = hashCode * 59 + RemoveGroups.GetHashCode();
        ...
        public static bool operator ==(FileFtpModify left, FileFtpModify right)
        {

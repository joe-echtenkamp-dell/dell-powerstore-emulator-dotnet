...
{ 
    /// <summary>
    /// Summary of nas server level performance metric data for the period beginning with timestamp, including the average and maximum values for that period.  Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByNasServerRollup : IEquatable<BasePerformanceMetricsByNasServerRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByNasServerRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByNasServerRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByNasServerRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByNasServerRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByNasServerRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByNasServerRollup left, BasePerformanceMetricsByNasServerRollup right)
        {

...
{ 
    /// <summary>
    /// Summary of node level performance metric data for various rollup intervals beginning with timestamp, including the average and maximum values for that period.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByNodeRollup : IEquatable<BasePerformanceMetricsByNodeRollup>
    { 
        /// <summary>
        ...
        /// <summary>
        /// The average percentage of CPU Utilization on the cores dedicated to servicing storage I/O requests. Derived from an average of utilization across all cores on the node.
        /// </summary>
        /// <value>The average percentage of CPU Utilization on the cores dedicated to servicing storage I/O requests. Derived from an average of utilization across all cores on the node.</value>
        ...
        /// <summary>
        /// The maximum percentage of CPU Utilization on the cores dedicated to servicing storage I/O requests. Derived from an average of utilization across all cores on the node.
        /// </summary>
        /// <value>The maximum percentage of CPU Utilization on the cores dedicated to servicing storage I/O requests. Derived from an average of utilization across all cores on the node.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByNodeRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByNodeRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByNodeRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByNodeRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByNodeRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByNodeRollup left, BasePerformanceMetricsByNodeRollup right)
        {

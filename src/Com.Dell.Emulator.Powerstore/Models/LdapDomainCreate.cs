...
{ 
    /// <summary>
    /// Create parameters of LDAP domain. Was added in version 1.0.3.
    /// </summary>
    [DataContract]
    public partial class LdapDomainCreate : IEquatable<LdapDomainCreate>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LdapDomainCreate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((LdapDomainCreate)obj);
        }

        /// <summary>
        /// Returns true if LdapDomainCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of LdapDomainCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LdapDomainCreate other)
        {
        ...
        public static bool operator ==(LdapDomainCreate left, LdapDomainCreate right)
        {

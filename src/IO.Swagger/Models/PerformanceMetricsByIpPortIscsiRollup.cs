...
{ 
    /// <summary>
    /// Performance metrics for the ip port (iSCSI) rolled up at various intervals. Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsByIpPortIscsiRollup : MetricsGenerateResponse, IEquatable<PerformanceMetricsByIpPortIscsiRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsByIpPortIscsiRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsByIpPortIscsiRollup)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsByIpPortIscsiRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsByIpPortIscsiRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsByIpPortIscsiRollup other)
        {
        ...
        public static bool operator ==(PerformanceMetricsByIpPortIscsiRollup left, PerformanceMetricsByIpPortIscsiRollup right)
        {

...
{ 
    /// <summary>
    /// Properties of x509 certificate.
    /// </summary>
    [DataContract]
    public partial class X509CertificateInstance : IEquatable<X509CertificateInstance>
    { 
        /// <summary>
        /// Unique identifier of X509 Certificate instance.
        /// </summary>
        /// <value>Unique identifier of X509 Certificate instance.</value>
        ...
        /// <summary>
        /// Indicates whether this is a valid X509 certificate. When X509 certificate is expired or X509 Certificate of server type missing either a private key or a valid certificate entry, it will be false.
        /// </summary>
        /// <value>Indicates whether this is a valid X509 certificate. When X509 certificate is expired or X509 Certificate of server type missing either a private key or a valid certificate entry, it will be false.</value>

        [DataMember(Name="is_valid")]
        public bool? IsValid { get; set; }

        /// <summary>
        /// Member certificates included in this x509_certificate. Member certificates should be remained in an ordered sequence.  Filtering on the fields of this embedded resource is not supported.
        /// </summary>
        /// <value>Member certificates included in this x509_certificate. Member certificates should be remained in an ordered sequence.  Filtering on the fields of this embedded resource is not supported.</value>
        ...
        /// </summary>
        /// <value>Localized message string corresponding to service</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class X509CertificateInstance {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((X509CertificateInstance)obj);
        }

        /// <summary>
        /// Returns true if X509CertificateInstance instances are equal
        /// </summary>
        /// <param name="other">Instance of X509CertificateInstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(X509CertificateInstance other)
        {
        ...
        public static bool operator ==(X509CertificateInstance left, X509CertificateInstance right)
        {

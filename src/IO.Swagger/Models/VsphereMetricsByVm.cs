...
{ 
    /// <summary>
    /// User virtual machine CPU/Memory utilization metrics from vSphere. Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class VsphereMetricsByVm : MetricsGenerateResponse, IEquatable<VsphereMetricsByVm>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VsphereMetricsByVm {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((VsphereMetricsByVm)obj);
        }

        /// <summary>
        /// Returns true if VsphereMetricsByVm instances are equal
        /// </summary>
        /// <param name="other">Instance of VsphereMetricsByVm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VsphereMetricsByVm other)
        {
        ...
        public static bool operator ==(VsphereMetricsByVm left, VsphereMetricsByVm right)
        {

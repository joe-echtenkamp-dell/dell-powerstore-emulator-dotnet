...
{ 
    /// <summary>
    /// Summary of host level performance metric data for various rollup intervals beginning with timestamp, including the average and maximum values for that period. Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BasePerformanceMetricsByHostRollup : IEquatable<BasePerformanceMetricsByHostRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasePerformanceMetricsByHostRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasePerformanceMetricsByHostRollup)obj);
        }

        /// <summary>
        /// Returns true if BasePerformanceMetricsByHostRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePerformanceMetricsByHostRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePerformanceMetricsByHostRollup other)
        {
        ...
        public static bool operator ==(BasePerformanceMetricsByHostRollup left, BasePerformanceMetricsByHostRollup right)
        {

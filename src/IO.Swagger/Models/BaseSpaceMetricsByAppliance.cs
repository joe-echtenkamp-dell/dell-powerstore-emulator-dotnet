...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BaseSpaceMetricsByAppliance : IEquatable<BaseSpaceMetricsByAppliance>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Total configured size of all storage objects on an appliance. This metric includes all primaries, snaps and clones.</value>
        ...
        /// </summary>
        /// <value>Amount of data in bytes written to all storage objects on an appliance, without any deduplication and/or compression. This metric includes all primaries, snaps and clones.</value>
        ...
        /// <summary>
        /// Amount of data in bytes written to all block volumes on an appliance, without any deduplication and/or compression. This metric includes all primaries, snaps and clones. Was added in version 2.0.0.0.
        /// </summary>
        /// <value>Amount of data in bytes written to all block volumes on an appliance, without any deduplication and/or compression. This metric includes all primaries, snaps and clones. Was added in version 2.0.0.0.</value>
        ...
        /// <summary>
        /// Amount of data in bytes written to all file systems on an appliance, without any deduplication and/or compression. This metric includes all primaries, snaps and clones. Was added in version 2.0.0.0.
        /// </summary>
        /// <value>Amount of data in bytes written to all file systems on an appliance, without any deduplication and/or compression. This metric includes all primaries, snaps and clones. Was added in version 2.0.0.0.</value>
        ...
        /// <summary>
        /// Amount of data in bytes written to all virtual volumes on an appliance, without any deduplication and/or compression. This metric includes all primaries, snaps and clones. Was added in version 2.0.0.0.
        /// </summary>
        /// <value>Amount of data in bytes written to all virtual volumes on an appliance, without any deduplication and/or compression. This metric includes all primaries, snaps and clones. Was added in version 2.0.0.0.</value>
        ...
        /// </summary>
        /// <value>Total combined space on the physical drives of the appliance available for data.</value>
        ...
        /// </summary>
        /// <value>Total physical space consumed in the appliance, accounting for all efficiency mechanisms, as well as all data protection.</value>
        ...
        /// </summary>
        /// <value>This metric represents amount of physical space user data occupies after deduplication and compression.</value>
        ...
        /// </summary>
        /// <value>Amount of space the volume family needs to hold the data written by host and shared by snaps and fast-clones in the family. This does not include deduplication or compression.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseSpaceMetricsByAppliance {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseSpaceMetricsByAppliance)obj);
        }

        /// <summary>
        /// Returns true if BaseSpaceMetricsByAppliance instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseSpaceMetricsByAppliance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseSpaceMetricsByAppliance other)
        {
        ...
        public static bool operator ==(BaseSpaceMetricsByAppliance left, BaseSpaceMetricsByAppliance right)
        {

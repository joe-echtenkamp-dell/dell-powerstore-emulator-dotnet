...
{ 
    /// <summary>
    /// Performance metrics for the ip port (total) rolled up at various intervals. Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsByIpPortRollup : MetricsGenerateResponse, IEquatable<PerformanceMetricsByIpPortRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsByIpPortRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsByIpPortRollup)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsByIpPortRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsByIpPortRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsByIpPortRollup other)
        {
        ...
        public static bool operator ==(PerformanceMetricsByIpPortRollup left, PerformanceMetricsByIpPortRollup right)
        {

...
{ 
    /// <summary>
    /// Cluster wide copy metrics for the replication group. Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseCopyMetricsByRg : IEquatable<BaseCopyMetricsByRg>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseCopyMetricsByRg {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseCopyMetricsByRg)obj);
        }

        /// <summary>
        /// Returns true if BaseCopyMetricsByRg instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseCopyMetricsByRg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCopyMetricsByRg other)
        {
        ...
        public static bool operator ==(BaseCopyMetricsByRg left, BaseCopyMetricsByRg right)
        {

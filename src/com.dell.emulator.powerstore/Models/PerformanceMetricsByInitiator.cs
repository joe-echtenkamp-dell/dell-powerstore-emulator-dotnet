...
{ 
    /// <summary>
    /// Performance metrics for the inititator collected at twenty second interval. Was added in version 3.0.0.0.
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsByInitiator : MetricsGenerateResponse, IEquatable<PerformanceMetricsByInitiator>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsByInitiator {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsByInitiator)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsByInitiator instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsByInitiator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsByInitiator other)
        {
        ...
        public static bool operator ==(PerformanceMetricsByInitiator left, PerformanceMetricsByInitiator right)
        {

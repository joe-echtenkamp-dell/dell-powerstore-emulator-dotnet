...
{ 
    /// <summary>
    /// Cluster wide copy metrics for the volume group. Was added in version 3.5.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseCopyMetricsByVgRollup : IEquatable<BaseCopyMetricsByVgRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseCopyMetricsByVgRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseCopyMetricsByVgRollup)obj);
        }

        /// <summary>
        /// Returns true if BaseCopyMetricsByVgRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseCopyMetricsByVgRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCopyMetricsByVgRollup other)
        {
        ...
        public static bool operator ==(BaseCopyMetricsByVgRollup left, BaseCopyMetricsByVgRollup right)
        {

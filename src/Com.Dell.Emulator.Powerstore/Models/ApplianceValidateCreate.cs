...
{ 
    /// <summary>
    /// Parameters for the appliance create (add) operation, used only for validation of the request in this validate_create request. Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class ApplianceValidateCreate : IEquatable<ApplianceValidateCreate>
    { 
        /// <summary>
        /// The link local address is a dynamically set local IP address. It is unique to this appliance and is set by Zeroconf. Use the PowerStore Discovery Tool to get the link local address. 
        /// </summary>
        /// <value>The link local address is a dynamically set local IP address. It is unique to this appliance and is set by Zeroconf. Use the PowerStore Discovery Tool to get the link local address. </value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplianceValidateCreate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ApplianceValidateCreate)obj);
        }

        /// <summary>
        /// Returns true if ApplianceValidateCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of ApplianceValidateCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplianceValidateCreate other)
        {
        ...
        public static bool operator ==(ApplianceValidateCreate left, ApplianceValidateCreate right)
        {

...
{ 
    /// <summary>
    /// Cluster wide copy metrics for the volume. Was added in version 3.5.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseCopyMetricsByVolumeRollup : IEquatable<BaseCopyMetricsByVolumeRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseCopyMetricsByVolumeRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseCopyMetricsByVolumeRollup)obj);
        }

        /// <summary>
        /// Returns true if BaseCopyMetricsByVolumeRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseCopyMetricsByVolumeRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCopyMetricsByVolumeRollup other)
        {
        ...
        public static bool operator ==(BaseCopyMetricsByVolumeRollup left, BaseCopyMetricsByVolumeRollup right)
        {

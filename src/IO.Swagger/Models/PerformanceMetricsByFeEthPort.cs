...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsByFeEthPort : MetricsGenerateResponse, IEquatable<PerformanceMetricsByFeEthPort>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsByFeEthPort {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsByFeEthPort)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsByFeEthPort instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsByFeEthPort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsByFeEthPort other)
        {
        ...
        public static bool operator ==(PerformanceMetricsByFeEthPort left, PerformanceMetricsByFeEthPort right)
        {

...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InitiatorCreateModify : IEquatable<InitiatorCreateModify>
    { 
        /// <summary>
        /// IQN name aka address or NQN name for NVMEoF port types.
        /// </summary>
        /// <value>IQN name aka address or NQN name for NVMEoF port types.</value>
        [Required]
        ...
        /// </summary>
        /// <value>Password for CHAP authentication. This value must be 12 to 64 UTF-8 characters. This password cannot be queried. CHAP password is required when the cluster CHAP mode is single authentication. </value>
        ...
        /// </summary>
        /// <value>Password for CHAP authentication. This value must be 12 to 64 UTF-8 characters. This password cannot be queried. CHAP password is required when the cluster CHAP mode is mutual authentication. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InitiatorCreateModify {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InitiatorCreateModify)obj);
        }

        /// <summary>
        /// Returns true if InitiatorCreateModify instances are equal
        /// </summary>
        /// <param name="other">Instance of InitiatorCreateModify to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InitiatorCreateModify other)
        {
        ...
        public static bool operator ==(InitiatorCreateModify left, InitiatorCreateModify right)
        {

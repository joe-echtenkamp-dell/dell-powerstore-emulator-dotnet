...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class X509CertificateCsrResponse : IEquatable<X509CertificateCsrResponse>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class X509CertificateCsrResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((X509CertificateCsrResponse)obj);
        }

        /// <summary>
        /// Returns true if X509CertificateCsrResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of X509CertificateCsrResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(X509CertificateCsrResponse other)
        {
        ...
        public static bool operator ==(X509CertificateCsrResponse left, X509CertificateCsrResponse right)
        {

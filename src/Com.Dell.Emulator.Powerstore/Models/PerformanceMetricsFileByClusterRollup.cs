...
{ 
    /// <summary>
    /// Summary of Cluster level file performance metric data for the period beginning with timestamp, including the average and maximum values for that period.  Was added in version 2.0.0.0.
    /// </summary>
    [DataContract]
    public partial class PerformanceMetricsFileByClusterRollup : MetricsGenerateResponse, IEquatable<PerformanceMetricsFileByClusterRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceMetricsFileByClusterRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PerformanceMetricsFileByClusterRollup)obj);
        }

        /// <summary>
        /// Returns true if PerformanceMetricsFileByClusterRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceMetricsFileByClusterRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceMetricsFileByClusterRollup other)
        {
        ...
        public static bool operator ==(PerformanceMetricsFileByClusterRollup left, PerformanceMetricsFileByClusterRollup right)
        {

...
{ 
    /// <summary>
    /// Copy metrics for the NAS server. Was added in version 4.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseCopyMetricsByNasServerRollup : IEquatable<BaseCopyMetricsByNasServerRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseCopyMetricsByNasServerRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseCopyMetricsByNasServerRollup)obj);
        }

        /// <summary>
        /// Returns true if BaseCopyMetricsByNasServerRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseCopyMetricsByNasServerRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCopyMetricsByNasServerRollup other)
        {
        ...
        public static bool operator ==(BaseCopyMetricsByNasServerRollup left, BaseCopyMetricsByNasServerRollup right)
        {

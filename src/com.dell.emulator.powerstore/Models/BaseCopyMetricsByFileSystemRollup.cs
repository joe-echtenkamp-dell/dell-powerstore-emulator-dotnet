...
{ 
    /// <summary>
    /// Copy metrics for the file system. Was added in version 4.0.0.0.
    /// </summary>
    [DataContract]
    public partial class BaseCopyMetricsByFileSystemRollup : IEquatable<BaseCopyMetricsByFileSystemRollup>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseCopyMetricsByFileSystemRollup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BaseCopyMetricsByFileSystemRollup)obj);
        }

        /// <summary>
        /// Returns true if BaseCopyMetricsByFileSystemRollup instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseCopyMetricsByFileSystemRollup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCopyMetricsByFileSystemRollup other)
        {
        ...
        public static bool operator ==(BaseCopyMetricsByFileSystemRollup left, BaseCopyMetricsByFileSystemRollup right)
        {
